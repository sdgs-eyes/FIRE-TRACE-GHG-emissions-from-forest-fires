...
def get_biomass(path_to_lookup_table, path_to_biomass_table, landcover, region=None):
    ...
    df_biomass = df_biomass.rename(columns={df_biomass.columns[0]:landcover, df_biomass.columns[1]:'BIOMASS'})
    ...
    df_biomass_uncertainty = df_biomass_uncertainty.rename(columns={df_biomass_uncertainty.columns[0]:landcover, df_biomass_uncertainty.columns[1]:'BIOMASS_STD'})
